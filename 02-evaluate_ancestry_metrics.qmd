...
female_ids <- gbr_females$FID

gbr_females_pca <- test_gbr_like %>% filter(FID %in% female_ids)

gbr_males_pca <- test_gbr_like %>% filter(!FID %in% female_ids)
